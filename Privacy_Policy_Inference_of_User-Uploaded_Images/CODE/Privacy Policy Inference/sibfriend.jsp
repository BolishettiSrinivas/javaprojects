...
<div id="#" width="650" style="margin-right:5px">
   	...
   	<div id="#" width="650" style="margin-left:2px; margin-right:2px;">  
		<form action="sibfriend.jsp" method="post">
			<table border="3" width="600" style="margin-left:2px; margin-right:2px;">
				...
				User Searching Images Based On Friend
				</caption> 
				<tr>
					...
					if(!fname.equalsIgnoreCase(""))
						{
							Statement st3 = connection.createStatement();
						   	String query3 ="insert into searchhistory(username,keyword,dt) values('"+uname+"','"+fname+"','"+dt+"')";
						   	st3.executeUpdate (query3); 	   
						}
			
			
			Statement stmt=connection.createStatement();
			String strQuery = "select * from images where uname  LIKE '%"+fname+"%' ";
