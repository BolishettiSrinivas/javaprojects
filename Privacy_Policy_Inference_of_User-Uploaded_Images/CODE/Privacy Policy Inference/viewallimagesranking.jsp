...
<html lang="en">
<head>
<title>PPI : View All Images Ranking</title>
<meta charset="utf-8">
      ...
      <div class="padding">
		...
		<div class="col-2">
          ...
          <div class="col-3">
			...
			<iframe src="listofimageswithranking.jsp" style="border:3px;" width="640" height="500"></iframe>
            <div class="indent">
    ...
    <footer>
      ...
      <div class="row-bot">
        <div class="aligncenter">
          ...
          Design by <a target="_blank" href="#">TMKS Infotech pvt ltd</a><br>
          <!-- {%FOOTER_LINK} -->
        </div>
      </div>
    </footer>
