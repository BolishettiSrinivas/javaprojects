          	...
          	User Recommended Images 
				...
				<%
					try{      
						...
						String strQuery1 = "select * from imagerecommend where recommendto='"+uname+"'";
						ResultSet rs1 = stmt1.executeQuery(strQuery1);
						while(rs1.next()){
						int k=rs1.getInt("imgid");
						String rec = rs1.getString(2);
						Statement stmt=connection.createStatement();
						String strQuery = "select * from images where id='"+k+"'";
			...
			%>	
				<tr>
					<td>
						...
						<p style="font-family:'Times New Roman', Times, serif;"><span style="color:#006666">Image Recommended By :</span> <%=rec%> </p>
                	</td>
					<td  width="600">
				...
				<tr>
					<td>
						<div style="margin:10px 13px 10px 13px; width:270px;" >
