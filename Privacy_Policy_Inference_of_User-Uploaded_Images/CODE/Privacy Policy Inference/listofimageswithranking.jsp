...
<div id="#" width="650" style="margin-right:5px">
		...
		<div id="gallery">  
          	...
          	List Of Images With Ranking And Rating 
          	</caption> <tr>
				<%
					try{      
				...
				<td>
					<div class="gallery_box" >
						...
						<p>
							<%
							if(rank>0 && rank<= 3){%>
								&nbspRank:[<%= rank%>]&nbsp;Rating :<img src="images/1.png" style="width:120px; height:20px;" />
							<%
							}
							else if(rank>3 && rank<= 6){%>
								&nbspRank:[<%= rank%>]&nbsp;Rating :<img src="images/2.png" style="width:120px; height:20px;" />
							<%
							}
							else if(rank>6 && rank<= 12){%>
								&nbspRank:[<%= rank%>]&nbsp;Rating :<img src="images/3.png" style="width:120px; height:20px;" />
							<%
							}
							else if(rank>12 && rank<= 24){%>
								&nbspRank:[<%= rank%>]&nbsp;Rating :<img src="images/4.png" style="width:120px; height:20px;" />
							<%
							}
							else if(rank>24){%>
								&nbspRank:[<%= rank %>]&nbsp;Rating :<img src="images/5.png" style="width:120px; height:20px;" />
						
							<%
							}else{
							%>
								&nbspRank:[<%= rank %>]&nbsp;Rating :<img src="images/0.png" style="width:120px; height:20px;" />
							<%
							}
							%>
						</p>
