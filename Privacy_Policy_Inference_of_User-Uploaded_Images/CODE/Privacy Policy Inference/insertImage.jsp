				...
				try {
					...
					File file1 = null;	
						...
						while (params.hasMoreElements()) 
						{
							...
							if(paramname.equalsIgnoreCase("annotation"))
							{
							...
							if(paramname.equalsIgnoreCase("policy"))
							{
							...
							for(String str :ee){
								checkBok=checkBok+"|"+str;
							}	
							if(checkBok.indexOf("All")>=0){
								checkBok="All";	
							}	
							int f = 0;
							...
							PreparedStatement ps=connection.prepareStatement("insert into images(tag,color,annotation,uses,policy,imagess,count,binaryimage,imagetitle,uname) values(?,?,?,?,?,?,?,?,?,?)");
							ps.setString(1,a);
							ps.setString(2,b);
							ps.setString(3,c);	
							ps.setString(4,d);
