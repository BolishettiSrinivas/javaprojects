...
<!-- 
	...
	by www.tooplate.com 
-->
<title>PPI :Search Based On Annotation</title>
...
<div id="#" width="650" style="margin-right:5px">
   	...
   	<div id="#" width="650" style="margin-left:2px; margin-right:2px;">  
		<form action="sibannotation.jsp" method="post">
			<table border="3" width="600" style="margin-left:2px; margin-right:2px;">
				...
				User Searching Images Based On Content
				</caption> 
				<tr>
		...
		try{   
			...
			String annotation = request.getParameter("keyword");   
			...
			if(!annotation.equalsIgnoreCase(""))
			{
				Statement st3 = connection.createStatement();
				String query3 ="insert into searchhistory(username,keyword,dt) values('"+uname+"','"+annotation+"','"+dt+"')";
			...
			%>	
				...
				%>
				<tr>
					<td><div style="margin:10px 13px 10px 13px; width:250px;" >
