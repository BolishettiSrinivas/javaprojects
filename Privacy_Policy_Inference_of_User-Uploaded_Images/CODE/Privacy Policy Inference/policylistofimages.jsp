...
<div id="#" width="650" style="margin-right:5px">
        ...
        <div id="#" width="650" style="margin-left:2px; margin-right:2px;">  
          	<table border="3" width="600" style="margin-left:2px; margin-right:2px;"><caption style="height:50px; background-color:#999999; font-size:18px; font-family:'Times New Roman', Times, serif;" valign="bottom">Click on Image and get Annotation</caption> <tr>
				<%
					try{      
						String s1=null,s2=null,s3=null,s4=null;
						String uname = (String)application.getAttribute("uname");
						Statement stmt=connection.createStatement();
						String strQuery = "select * from images where uname='"+uname+"'order by count DESC";
