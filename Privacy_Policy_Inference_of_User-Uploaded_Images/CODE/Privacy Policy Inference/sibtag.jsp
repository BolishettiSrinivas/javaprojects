...
<div id="#" width="650" style="margin-right:5px">
   	...
   	<div id="#" width="650" style="margin-left:2px; margin-right:2px;">  
		<form action="sibtag.jsp" method="post">
			<table border="3" width="600" style="margin-left:2px; margin-right:2px;">
				...
				User Searching Images Based On Tag
				</caption> 
				<tr>
		...
		<%
		try{   
			String tag1 = request.getParameter("keyword");   
			...
			if(!tag1.equalsIgnoreCase(""))
			{
				...
				String query3 ="insert into searchhistory(username,keyword,dt) values('"+uname+"','"+tag1+"','"+dt+"')";
				st3.executeUpdate (query3); 	   
			}
			
			Statement stmt=connection.createStatement();
			String strQuery = "select * from images where tag  LIKE '%"+tag1+"%' ";
