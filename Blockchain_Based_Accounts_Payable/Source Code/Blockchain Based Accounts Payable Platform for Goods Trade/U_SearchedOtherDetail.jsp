...
<%@ page import="java.text.SimpleDateFormat, java.util.Date"%>
    ...
    %></td></tr>
	 ...
	 <table align="left">
<tr>
  <td><a href="U_MakeOtherComment.jsp?id=<%=id%>&name=<%=s1%>"> COMMENT </a></td>
</tr>
</table>
 <table align="left">
<tr>
 <td><a href="Buy_Verification1.jsp?name=<%=s1%>&id=<%=id%>"> BUY </a></td>
</tr>
</table>
...
<h2 align="right">&nbsp;</h2>
            ...
            <h2 align="right"><a href="U_TopKOthSearch.jsp" class="style4">Back</a></h2>
			<%}else if(type.equalsIgnoreCase("search")){%>
            <h2 align="right"><a href="U_SearcOther.jsp" class="style4">Back</a></h2>
			<%}
