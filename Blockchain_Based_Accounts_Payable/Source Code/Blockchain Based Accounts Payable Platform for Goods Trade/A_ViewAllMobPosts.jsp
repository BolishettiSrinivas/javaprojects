...
<head>
<title>Admin View Mobile Posts</title>
...
dispute management, blockchain, smart contract</h2>
  ...
  <div class="body">
    <div class="body_resize">
      <div class="left">
	  <h2><span class="style3">Admin</span> <span class="style3">View</span> <span class="style3">Mobile</span> <span class="style3">posts</span> </h2>
  ...
  <table width="601" border="1" align="center"  cellpadding="0" cellspacing="0"  ">
            ...
            <%
						...
						try 
						{
						   	String query="select * from mposts order by rank desc"; 
            ...
            <tr>
			  ...
			  <td height="0"  valign="baseline" bgcolor="#FF0000"><p class="style22 style4 style5 style5">&nbsp;</p>
                  <div align="center" class="style22 style4 style5 style5">
                      ...
                      <span class="style8">
                      <a href="A_ViewAllMobPostsConti.jsp?name=<%=s1%>&id=<%=i%>&type=<%="adminview"%>">
                      <%out.println(s1);%>
                      </a></span>
                      <p>&nbsp; </p>
              </div></td>
