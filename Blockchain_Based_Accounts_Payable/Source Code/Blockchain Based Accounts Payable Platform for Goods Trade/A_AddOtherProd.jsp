...
<head>
<title>Admin Add Other Posts</title>
...
dispute management, blockchain, smart contract</h2>
  ...
  <div class="body">
    <div class="body_resize">
      <div class="left">
	  <h2><span class="style3">Admin</span> <span class="style3">Add</span> <span class="style3">Other Posts</span> <span class="style3">Status</span> </h2>
                           <p>
...
<form name="s" method="post" enctype="multipart/form-data" action="A_AddOtherProdConf.jsp" onSubmit="return valid()"  ons target="_top">
 
  <table width="405" border="0" align="center">
    <tr>
      <td width="165" height="33" bgcolor="#FF0000"><div align="center" class="style5"><span class="style8">Select the Categorie </span></div></td>
      <td width="230"><label>
	...
	%>
	<tr>
      <td width="165" height="33" bgcolor="#FF0000"><div align="center" class="style5"><span class="style8">Select the Sub-Categorie </span></div></td>
      <td width="230"><label>
    ...
    <tr>
      <td height="36" bgcolor="#FF0000"><div align="center" class="style5"><span class="style8"> Product Name </span> </div></td>
      <td><label>
	 ...
	 <tr>
      <td height="35" bgcolor="#FF0000"><div align="center" class="style5"><span class="style8">Price </span></div></td>
      <td><label>
        <input type="text" id="t3" name="price">
      </label></td>
    </tr>
    <tr>
      <td height="51" bgcolor="#FF0000"><div align="center" class="style5"><span class="style8"> Manufacturer </span></div></td>
      <td><label>
        <input type="text" id="t3" name="manu">
      </label></td>
    </tr>
   <tr>
      <td height="51" bgcolor="#FF0000"><div align="center" class="style5"><span class="style8"> Model </span></div></td>
      <td><label>
        <input type="text" id="t3" name="model">
      </label></td>
    </tr>
	<tr>
      <td height="51" bgcolor="#FF0000"><div align="center" class="style5"><span class="style8"> Color </span></div></td>
      <td><label>
        <input type="text" id="t3" name="color">
      </label></td>
    </tr>
	<tr>
      <td height="51" bgcolor="#FF0000"><div align="center" class="style5"><span class="style8"> Description </span></div></td>
      <td><label>
        <textarea name="desc" id="t2"></textarea>
      </label></td>
    </tr>
    <tr>
      <td height="38" bgcolor="#FF0000"><div align="center" class="style5"><span class="style8">  Image </span></div></td>
