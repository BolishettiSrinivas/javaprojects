    ...
    <div class="body_resize">
      <div class="left">
		...
		<%				
		 ...
		 %>
		 <p class="style13"><a href="U_SearchedMobileDetail.jsp?name=<%=s1%>&id=<%=id%>"><span class="style15 style7"><%="  "+s1%></span> </a></p>
     <%
		...
		<%				
		 ...
		 %>
		 <p class="style13"><a href="U_SearchedOtherDetail.jsp?name=<%=s1%>&id=<%=id%>"><span class="style15 style7"><%="  "+s2%></span> </a></p>
     <%
		} 		
						 }
						 catch(Exception e){}
