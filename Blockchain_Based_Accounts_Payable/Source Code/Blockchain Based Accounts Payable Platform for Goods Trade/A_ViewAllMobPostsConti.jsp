...
<head>
<title>Admin View Post Details</title>
...
<%@ page import="java.text.SimpleDateFormat, java.util.Date"%>
		...
		//int id=Integer.parseInt(request.getParameter("id")); 
				...
				<tr>
				  <td height="0" bgcolor="#FF0000"> <h4 class="style28 style5" >Size:</h4></td>
				...
				<tr>
				  <td height="0" bgcolor="#FF0000"> <h4 class="style28 style5" >OS:</h4></td>
					<td class="style28" > <%=s7%></td>
				</tr>
				<tr>
				  <td height="0" bgcolor="#FF0000"> <h4 class="style28 style5" >Internal Memory:</h4></td>
					<td class="style28" > <%=s8%></td>
				</tr>
				<tr>
				  <td height="0" bgcolor="#FF0000"> <h4 class="style28 style5" >External Memory:</h4></td>
					<td class="style28" > <%=s9%></td>
				</tr>
				<tr>
				  <td height="0" bgcolor="#FF0000"> <h4 class="style28 style5" >Mobile Processor:</h4></td>
					<td class="style28" > <%=s10%></td>
				</tr>
				<tr>
				  <td height="0" bgcolor="#FF0000"> <h4 class="style28 style5" >Mobile Descrition:</h4></td>
  ...
  <h2 align="right">&nbsp;</h2>
            ...
            <h2 align="right"><a href="A_ViewAllMobPosts.jsp" class="style4">Back</a></h2>
			<%}
			else if(type.equalsIgnoreCase("reviews"))
			{%>
            <h2 align="right"><a href="A_ViewReviewsMob.jsp" class="style4">Back</a></h2>
			<%}
