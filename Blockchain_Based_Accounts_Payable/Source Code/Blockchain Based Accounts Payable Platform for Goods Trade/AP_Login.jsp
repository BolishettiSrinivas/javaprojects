...
dispute management, blockchain, smart contract.</h2>
  ...
  <div class="body">
    <div class="body_resize">
      <div class="left">
	  <h2> Account PayableLogin </h2>
      <form name="s" action="Authentication.jsp?value=<%="aplogin"%>" method="post" onSubmit="return valid()"  ons target="_top"> 
            <table width="454" border="0" cellpadding="2" cellspacing="2">
              <tr>
                <td height="62" colspan="2" align="center"><img src="images/ulogin.jpg" width="429" height="135" /></td>
              </tr>
              <tr>
                <td width="212" height="62" align="center"><div align="center" class="style29">User Name<span class="style31"> *</span></div></td>
