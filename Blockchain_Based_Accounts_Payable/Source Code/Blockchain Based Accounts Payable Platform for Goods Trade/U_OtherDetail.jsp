...
<head>
<title>User Search Posts Details</title>
...
dispute management, blockchain, smart contract.</h2>
  ...
  <div class="body">
    <div class="body_resize">
      <div class="left">
	  <h2><span class="style3">User</span> <span class="style3">View</span> <span class="style3"></span> <span class="style3"><%=request.getParameter("name")%></span> </h2>
     <table width="500" >
...
<%@ page import="java.text.SimpleDateFormat, java.util.Date"%>
		...
		//int id=Integer.parseInt(request.getParameter("id")); 
						...
						{	
							...
							ArrayList al=new ArrayList();
						   	...
						   	String sql="select * from oposts where id='"+id+"'"; 
				...
				<img src="images.jsp?id=<%=i%>&value=<%="oimage"%>" width="130" height="100" align="middle" />				</td>
				</tr>
				<tr>
				...
				<tr>
				  <td height="0" bgcolor="#FF0000"> <h4 class="style28 style3" >Manufacturer:</h4></td>
					<td class="style28" > <%=s6%></td>
				</tr>
				<tr>
				  <td height="0" bgcolor="#FF0000"> <h4 class="style28 style3" >Model:</h4></td>
					<td class="style28" > <%=s7%></td>
				</tr>
				<tr>
				  <td height="0" bgcolor="#FF0000"> <h4 class="style28 style3" >Description:</h4></td>
    ...
    %></td></tr>
	 ...
	 <table border="1" >
            <tr bgcolor="#99FF99">
              <td  width="47" height="34" valign="baseline" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style15 style21 style7 style6 style5 style3"> SI NO </div></td>
			  <td  width="114" height="34" valign="baseline" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style15 style21 style7 style6 style5 style3">Comment </div></td>
			  <td  width="112" height="34" valign="baseline" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style15 style21 style7 style6 style5 style3">Commented By</div></td>
              <td  width="82" height="34" valign="baseline" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style15 style21 style7 style6 style5 style3"> Date </div></td>
          </tr>
           
            <%
					     
				
						String s101,s20,s30,s40,s50,s60;
						int j=1;
						try 
						{
						   	String query="select * from ocomment where oname='"+name+"' "; 
						   	Statement st=connection.createStatement();
		...
		<p align="right"><a href="U_AllProducts.jsp">Back</a></p>	 
      </div>
      <div class="right">
        <h2>Home Menu</h2>
        <ul>
