...
<head>
<title>Admin Mobile Chart</title>
...
dispute management, blockchain, smart contract</h2>
  ...
  <div class="body">
    <div class="body_resize">
      <div class="left">
	  <h2 align="center" class="style5"><span class="style3">View all Product post Chart Results..</span></h2>
	  <iframe src="Results.jsp" height="400" width="600"></iframe>
		  <div align="center" class="style51">( Number of Times commented and Buy post )	      </div>
