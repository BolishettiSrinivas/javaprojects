...
<head>
<title>Admin View Purchased Products</title>
...
dispute management, blockchain, smart contract</h2>
  ...
  <div class="body">
    <div class="body_resize">
      <div class="left">
	  <h2><span class="style3">Admin</span> <span class="style3">View</span> <span class="style3">Products Bill</span>  </h2>
  ...
  <table width="601" border="1" align="center"  cellpadding="0" cellspacing="0"  ">
            <tr bgcolor="#99FF99">
			  ...
			  <td  width="114" height="34" valign="baseline" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style15 style21 style7 style6 style5">Customer</div></td>
		      <td  width="114" height="34" valign="baseline" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style15 style21 style7 style6 style5">Date</div></td>
			...
			int sum=0;
						...
						try 
						{
						   	String query="select * from buy where status='Processed'"; 
