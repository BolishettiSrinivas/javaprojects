...
<head>
<title>User Search Posts Comment</title>
...
<%@ page import="java.text.SimpleDateFormat, java.util.Date"%>
    ...
    %></td></tr>
	  ...
	  <form name="s" action="U_MakeOtherCommentIns.jsp?id=<%=i%>&iname=<%=s1%>" method="post"  onSubmit="return valid()"  ons target="_top">
	...
	<table width="600" border="0" align="center"  cellpadding="0" cellspacing="0"  style="border-collapse: collapse; display:inline; margin:10px 10px 10px 10px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:14px;">
					<tr>
 						<td   width="100" align="left" valign="middle" height="45" style="color: #2c83b0;"><div align="left" class="style1" style="margin-left:20px;">Comment</div></td>
	 ...
	 <p align="right"><a href="U_SearchedOtherDetail.jsp?id=<%=id%>&name=<%=s1%>&type=<%="comment"%>">Back</a></p>
      </div>
      <div class="right">
        <h2>Home Menu</h2>
        <ul>
