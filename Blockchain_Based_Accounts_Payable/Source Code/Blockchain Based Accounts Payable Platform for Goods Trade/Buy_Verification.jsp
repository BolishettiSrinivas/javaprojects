...
dispute management, blockchain, smart contract</h2>
  ...
  <div class="body">
    <div class="body_resize">
      <div class="left">
	  <h2><span class="style3">Buy</span> <span class="style3">Mobile</span> <span class="style3"><%=request.getParameter("name")%></span> </h2>
...
<%
    ...
    try
	{
			...
			if(rs.next()==true)
			{
								...
								String sql1="SELECT * FROM mposts where m_name='"+mname+"' and id='"+id+"' ";
								...
								if(rs1.next()==true)
								{
										...
										if(pprice>uamount)
										{
											...
											%>
											<a href="Add_Amount1.jsp?type=<%="msearch"%>">ADD AMOUNT</a>
											<%
										}
										else
										{
												...
												String sql30="Update mposts set rank="+rank+"  where id='"+id1+"' ";
