...
<head>
<title>Admin View Other Posts</title>
...
dispute management, blockchain, smart contract</h2>
  ...
  <div class="body">
    <div class="body_resize">
      <div class="left">
	  <h2><span class="style3">Admin</span> <span class="style3">View</span> <span class="style3">Other</span> <span class="style3">posts</span> </h2>
  <table width="601" border="1" align="center"  cellpadding="0" cellspacing="0"  ">
            <tr bgcolor="#99FF99">
              ...
              <td  width="82" height="34" valign="baseline" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style15 style21 style7 style6 style5">Rank</div></td>
          </tr>
            ...
            <%
						...
						try 
						{
						   	String query="select * from oposts order by rank desc"; 
            ...
            <tr>
              ...
              <td width="116" rowspan="1" bgcolor="#FF0000" ><div class="style22 style4 style5 style5" style="margin:10px 13px 10px 13px;" > <a class="#" id="img1" href="#" >
                  <input  name="image" type="image" src="images.jsp?id=<%=i%>&value=<%="oimage"%>" style="width:90px; height:90px;"  />
              </a> </div></td>
			  <td height="0"  valign="baseline" bgcolor="#FF0000"><p class="style22 style4 style5 style5">&nbsp;</p>
                  <div align="center" class="style22 style4 style5 style5">
                   
                      <span class="style8">
                      <a href="A_ViewAllOtherPostsConti.jsp?name=<%=s1%>&id=<%=i%>&type=<%="adminview"%>">
                      <%out.println(s1);%>
                      </a></span>
                      <p>&nbsp; </p>
              </div></td>
