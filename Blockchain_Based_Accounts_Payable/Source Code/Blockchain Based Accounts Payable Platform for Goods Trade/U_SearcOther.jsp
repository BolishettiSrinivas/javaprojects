  ...
  <div class="body">
    <div class="body_resize">
      <div class="left">
                ...
                <h2 class="style4"> <span class="style3">Search</span> <span class="style3">Other</span> <span class="style3">Posts</span></h2>
                      <h1>&nbsp;</h1>
					  
               <form name="s" action="U_SearcOther.jsp" method="post" onSubmit="return valid()"  ons target="_top">   
	  ...
	  try
							...
							String user=(String)application.getAttribute("uname");
								...
								String sql8="select * from oposts ";
								...
								while(rs8.next())
									...
									i=rs8.getInt(1);
								    s10 = rs8.getString(2);
									s20 = rs8.getString(10);
									s30 = rs8.getString(7);    
									int s40 = rs8.getInt(11);
								      total++;
			...
			<div align="center" class="style7" style="margin:10px 13px 10px 13px;" ><a class="#" id="img1" href="#" >
			 <input  name="image" type="image" src="images.jsp?id=<%=i%>&value=<%="oimage"%>" style="width:50px; height:50px;"  />
			 </a></div>	</td>
               <p> <div align="center" class="style11"><span class="style4">Product Name : </span><span class="style15"> <%=s10%></span></div></p>
                ...
                <p><div align="center" class="style5 style14"><span class="style11">View <a href="U_SearchedOtherDetail.jsp?id=<%=i%>&name=<%=s10%>&type=<%="search"%>">Details</a></span></div></p>
                <p></p>
				<div>
  ...
  String sql1="insert into searchratio(keyword,found,total,ratio,dt)values('"+keyword+"','"+(int)found+"','"+(int)total+"','"+ratio+"','"+dt+"')";
      ...
      <div class="right">
		...
		<%				
		 ...
		 %>
		 <p class="style13"><a href="U_SearchedOtherDetail.jsp?name=<%=s1%>&id=<%=id%>&type=<%="search"%>"><span class="style15 style7"><%="  "+s1%></span> </a></p>
     <%
		...
		<%				
		 ...
		 %>
		 <p class="style13"><a href="U_SearchedOtherDetail.jsp?name=<%=s1%>&id=<%=id%>&type=<%="search"%>"><span class="style15 style7"><%="  "+s2%></span> </a></p>
     <%
		} 
		...
		<%				
		 ...
		 %>
		 <p class="style13"><a href="U_SearchedOtherDetail.jsp?name=<%=s1%>&id=<%=id%>&type=<%="search"%>"><span class="style15 style7"><%="  "+s6%></span> </a></p>
     <%
		} 
		}
