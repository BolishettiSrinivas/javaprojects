...
<head>
<title>Admin search ratio </title>
...
dispute management, blockchain, smart contract</h2>
  ...
  <div class="body">
    <div class="body_resize">
      <div class="left">
	  <h2 align="center" class="style5"><span class="style3">View all Posts search Ratio Results..</span></h2>
	  <iframe src="Reasults2.jsp" height="400" width="600"></iframe>
	  
		  <div align="center" class="style51">(Based on Number of times searched posts) </div>
