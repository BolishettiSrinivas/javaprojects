...
<head>
<title>Admin Add Mobile Products</title>
...
dispute management, blockchain, smart contract</h2>
  ...
  <div class="body">
    <div class="body_resize">
      <div class="left">
	  <h2><span class="style3">Admin</span> <span class="style3">Add</span> <span class="style3">Moble Post</span> <span class="style3">Status</span> </h2>
            <p>
...
<%@ page import="java.util.Random,java.io.PrintStream, java.io.FileOutputStream, java.io.FileInputStream, java.security.DigestInputStream, java.math.BigInteger, java.security.MessageDigest, java.io.BufferedInputStream" %>
            <%
					...
					String categorie=null,name=null,subcategorie=null,price=null,size=null,image=null,bin = "", paramname=null,os=null,im=null,em=null,color=null,processor=null,desc=null;
					...
					try {
						...
						while (params.hasMoreElements()) 
						{
							...
							{
								size=multi.getParameter(paramname);
							}
							if(paramname.equalsIgnoreCase("os"))
							{
								os=multi.getParameter(paramname);
							}
							if(paramname.equalsIgnoreCase("im"))
							{
								im=multi.getParameter(paramname);
							}
							if(paramname.equalsIgnoreCase("em"))
							{
								em=multi.getParameter(paramname);
							}
							if(paramname.equalsIgnoreCase("color"))
							{
								color=multi.getParameter(paramname);
							}
							if(paramname.equalsIgnoreCase("processor"))
							{
								processor=multi.getParameter(paramname);
							}
			...
			<p class="style8">Please Select the Categorie</p>
		            ...
		            else
					{
						FileInputStream fs1 = null;
			 			String query1="select * from mposts  where m_name='"+name+"' "; 
					...
					if ( rs1.next() )
					   {
					   		out.print("Mobile post Name Already Exist");
			...
			<p><a href="A_AddMobileProd.jsp" class="style7">Back</a></p>
				...
				//Generate Hash Code Based on Descritption Start
					...
					PreparedStatement ps=connection.prepareStatement("insert into mposts(m_name,m_price,m_size,m_color,m_os,m_im,m_em,m_processer,m_desc,m_image,categorie,subcategorie,rank,h_code) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
						...
						ps.setString(11,categorie);
						ps.setString(12,subcategorie);
				        ps.setInt(13,rank);
						ps.setString(14,hcode);
						ps.executeUpdate();
					   
						
							out.print("Mobile post Uploaded Successfully");
