...
dispute management, blockchain, smart contract.</h2>
  ...
  <div class="body">
    <div class="body_resize">
      <div class="left">
	  <h2> WelCome Buyer <%=application.getAttribute("uname")%></h2>
	  <p><img src="images/UserMain.jpg" width="596" height="409" /></p>
      </div>
      <div class="right">
        <h2>Home Menu</h2>
        <ul>
          ...
          <li><a href="U_SearchMobile.jsp">Search Mobile Products</a></li>
		  <li><a href="U_SearcOther.jsp">Search Other Products</a></li>
		  <li><a href="U_SearchHistory.jsp">View My Search History</a></li>
		  <li><a href="U_AllProducts.jsp">View All Products</a></li>
		  <li><a href="U_TopKMobSearch.jsp">View Top K Mobile Products</a></li>
		  <li><a href="U_TopKOthSearch.jsp">View Top K Other Products</a></li>
